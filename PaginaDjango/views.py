...
direccionCristian = "D:/Cristian/Docu_Tesis/Tesis/PaginaDjango/static/Imagenes/Pr.jpg"
dirCrisDatos = "D:/Cristian/Docu_Tesis/Tesis/PaginaDjango/Datos/"
        ...
        for cnt in cnts:
            if cv2.contourArea(cnt) > 500:
                ...
                if x <= xlimite and cont <= 2:
                    if cont == 2:
                        cv2.imwrite(
                            'D:\Cristian\Docu_Tesis\detector\ifigura1.jpg', frame2)

                        # PARA IMAGEN EN EL PC
                        filepath = 'D:\Cristian\Docu_Tesis\detector\ifigura1.jpg'
                        with open(filepath, mode='rb') as image_stream:
                            # Call API with remote image
                            tags_result_remote = cv_client.tag_image_in_stream(
                                image_stream, language="es")
